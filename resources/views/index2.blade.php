...
@section('content')
<body
        class="home page-template-default page page-id-9 wp-custom-logo no-sidebar"
    >
        <svg
                    ...
                    <div class="cv_header_col">
                        <a
                            ...
                            ><img
                                width="190"
                                height="18"
                                src="https://thecapvestgroup.com/wp-content/uploads/2022/03/groupe-capvest-logo.svg"
                                class="custom-logo"
                            ...
                            >
                                ...
                                >
                                    <a href="#subsidiaries-presentation"
                                        ><span
                                            >The subsidiaries of the Group</span
                                        ></a
                                    >
                                </li>
                                <li
        ...
        <section
            class="cv_hero"
            style="
                background-image: url(https://thecapvestgroup.com/wp-content/uploads/2022/03/groupe-capvest-hero-scaled.jpg);
            "
        >
            <div class="container">
                <div class="cv_hero_row">
                    <div class="cv_hero_col">
                        <h1 class="cv_hero_title">The Capvest Group</h1>
                        <h2 class="cv_hero_text">
                            Experts in investment, development and management in
                ...
                <div class="cv_presentation_row">
                    <div class="cv_presentation_col">
                        <div class="cv_section_text">
                            <p>
                                The Groupe Capvest was founded by Magid Khoury
                                in 2001 with the assumed objective of becoming a
                                recognized player in real estate in Switzerland
                                and internationally as well as carrying a real
                                estate of strong conviction with a high level of
                                architectural requirement.
                            </p>
                            <p>
                                Investor, developer, and manager, the Capvest
                                Group has thus developed and diversified by
                                offering innovative concepts in residential,
                                tertiary, school, medical real estate, and in
                                recent years as part of large residential or
                                mixed urban operations at the scale of a
                                district.
                            </p>
                            <p>
                                With more than 50 employees spread across our
                                offices in Geneva, Lisbon and Montreal, Capvest
                                ...
                                chain of a real estate project: acquisition,
                ...
                <div class="cv_notre_philosophie_row" id="our-philosophy">
                    ...
                    <div class="cv_notre_col">
                        ...
                        <div class="cv_section_text">
                            <h4>VISION</h4>
                            <p>
                                We want to develop the real estate of tomorrow
        ...
        <section class="cv_presentation_various" id="subsidiaries-presentation">
            <div class="container">
                ...
                <div class="cv_presentation_various_row pv_row_1">
                ...
                <div class="cv_presentation_various_row pv_row_2">
                    <div class="cv_presentation_various_col">
                        <div class="cv_presentation_various_logo">
                            <img
                        ...
                        <h3 class="cv_presentation_various_subtitle">CANADA</h3>
                        <div class="cv_presentation_various_text">
                            <p>
                ...
                <div class="cv_presentation_various_row pv_row_3">
                    <div class="cv_presentation_various_col">
                        <div class="cv_presentation_various_logo">
                            <img
                ...
                <div class="cv_presentation_various_row pv_row_4">
                    <div class="cv_presentation_various_col">
                        <div class="cv_presentation_various_logo">
                            <img
                        ...
                        <h3 class="cv_presentation_various_subtitle">
                            INTERNATIONAL PHILANTHROPIC FUND
                        </h3>
                        <div class="cv_presentation_various_text">
                            <p>
